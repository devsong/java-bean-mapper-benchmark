...
public class BeanMapBenchmarkForOrder {
    ...
    public OrderResponse setterGetter() {
        ...
        response.setOs(dto.getOs());
        response.setBt(dto.getBt());
        response.setSource(dto.getSource());
        response.setId(dto.getId());
        response.setTid(dto.getTid());
        response.setDid(dto.getDid());
        response.setPid(dto.getPid());
        response.setEoid(dto.getEoid());
        response.setOid(dto.getOid());
        response.setMu(dto.getMu());
        response.setRtt(dto.getRtt());
        response.setOt(dto.getOt());
        response.setSt(dto.getSt());
        response.setPt(dto.getPt());
        response.setCt(dto.getCt());
        response.setDt(dto.getDt());
        response.setPs(dto.getPs());
        response.setPct(dto.getPct());
        response.setAdt(dto.getAdt());
        response.setSa(dto.getSa());
        response.setEa(dto.getEa());
        response.setEad(dto.getEad());
        response.setGm(dto.getGm());
        response.setGmc(dto.getGmc());
        response.setOp(dto.getOp());
        response.setObf(dto.getObf());
        return response;
    }
}
